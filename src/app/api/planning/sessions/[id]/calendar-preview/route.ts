import { authenticatedPlanningClient, getPlanningCalendarEventPreview } from '@/lib/planning/server';
...
export async function GET(_request: Request, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    return planningJson(await getPlanningCalendarEventPreview(client, user.id, id));
