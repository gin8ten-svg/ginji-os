import { authenticatedPlanningClient, getPlanningExecutionPreview } from '@/lib/planning/server';
...
export async function GET(_request: Request, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    return planningJson(await getPlanningExecutionPreview(client, user.id, id));
